<template>
    ...
    <van-image  class="knowledge_details_img"  width="400" height="300"  fit="fill" :src="Image()"/>
        ...
        <div>关键词:</div>
        <van-col span="3">{{sort.sort_type_0}}</van-col>
        <van-col span="3">{{sort.sort_type_1}}</van-col>
        <van-col span="3">{{sort.sort_type_2}}</van-col>
        <van-col span="3">{{sort.sort_type_3}}</van-col>
        <van-col span="3">{{sort.sort_type_4}}</van-col>
        <van-col span="3.5">{{sort.sort_type_5}}</van-col>
        <van-col span="4">{{sort.sort_type_6}}</van-col>
      </van-row>
                <div>,,,,,, </div> 
                <div></div>
            </div>
