<template>
    <div id="knowledge_details">
        ...
        <div class="knowledge_details_main">
            ...
            <!-- <img class="knowledge_details_img" :src="Image()"> -->
            <div class="knowledge_details_img"> </div>
    <van-image    width="200" height="100"  fit="contain" :src="Image()"/>
            ...
            <div class="knowledge_details_knowledge_key">
                关键词: {{sort.sort_type_0}}--{{sort.sort_type_1}}--{{sort.sort_type_2}}--{{sort.sort_type_3}}--{{sort.sort_type_4}}--{{sort.sort_type_5}}--{{sort.sort_type_6}} 
            </div>
