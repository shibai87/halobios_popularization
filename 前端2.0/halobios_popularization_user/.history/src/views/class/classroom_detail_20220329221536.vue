<template>
    <div id="activity_details">
        ...
        <div class="classroom_details_main">
            ...
            <video controls :src="Video()" width="400" height="300" class="classroom_video"></video>
...
// import Comment from "../../components/comment.vue"
    export default {
        ...
        methods: {
            ...
            // 获取需编辑的知识详情
            getLoadclassroom() {
                this.axios.get("http://192.168.1.103:8083/video/get_video?video_id=" + this.getclassroom)
                    .then((res) => {
              ...
              Video() {
        var url = "http://localhost:8083/video/" + this.ruleForm.video_file_name
        console.log(url)
        return url
      },
        },
        computed: {
            getclassroom() {
                return JSON.parse(localStorage.getItem('classroom_id'));
            },
            getSortListLastId() {
