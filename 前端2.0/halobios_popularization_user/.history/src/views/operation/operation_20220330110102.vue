<template>
    <div id="user_comment">
        <van-nav-bar title="" left-arrow fixed @click-left="pageBack" />
                ...
                <div v-for="(item,index) in commentList" :key="index">
                    <van-row>
                        ...
                        <van-col span="5" offset="2" class="comment_other_operation">
                            <van-button size="small" type="primary" @click="user_operation_detail(item.operation_source_type)">查看详情</van-button>
                        </van-col>
                    </van-row>
                </div>
            </div>
