<template>
  <div id="user_infos">
      ...
      <van-form @submit="onSubmit">
          <van-field v-model="info.image"  type="image"  name="用户名" label="用户名" alt="Submit" clearable  />
      ...
      <van-field v-model="info.pwd" type="password" name="密码" label="密码"  clearable 
        :focused="showKeyboard_pwd" @focus="showKeyboard_pwd = true" :rules="[{  message: '请填写密码' }]" />
