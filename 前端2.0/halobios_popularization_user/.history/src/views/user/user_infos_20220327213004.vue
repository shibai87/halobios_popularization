    ...
    methods: {
      ...
      onSubmit() {
        ...
        console.log(this.user_name)
          this.axios.get("http://192.168.1.103:8083/user/updateUserInfo?user_name="+this.user_name +"&user_pwd=" +this.user_pwd+ "&user_sex=" +this.user_sex+ "&user_id=" +this.getUserId)
          .then((res) => {
            console.log("登录提示:");
            console.log(res.data);
