<template>
 ...
 <van-field v-model="info.user_name" label="用户名" placeholder="请输入用户名" />

   <van-row  class="sex">
  <van-col span="4"> <div class="sex_title">性别</div></van-col>
  <van-col span="20"> <van-radio-group v-model="radio" direction="horizontal">
