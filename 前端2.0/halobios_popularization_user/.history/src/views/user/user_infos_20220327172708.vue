<template>
  <div id="user_infos">
    ...
    <van-form @submit="onSubmit">
      <van-uploader v-model="fileList" multiple :max-count="1" accept="image/*" :after-read="imgUrl" :before-read="before_read"/>
      <!-- <van-image
  width="100px"
  height="100px"
  fit="contain"
...
<script>
  export default {
    ...
    methods: {
      ...
      before_read (val,val1){
         console.log(this.fileList,val,val1)
      },
      // imgUrl(val,val1){
      //   console.log(this.fileList,val,val1)
      // },
