<template>
  <div id="user_infos">
    ...
    <van-field v-model="tel" type="tel" label="手机号"  placeholder="请输入用户名"/>
     <van-field maxlength="25" v-model="param.email" label="邮箱" placeholder="请输入邮箱ID" :formatter="formatter" :error-message="errorText" />
    <van-row class="sex">
...
————————————————
版权声明：本文为CSDN博主「weixin_45108907」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/weixin_45108907/article/details/112271246
      onSubmit() {
