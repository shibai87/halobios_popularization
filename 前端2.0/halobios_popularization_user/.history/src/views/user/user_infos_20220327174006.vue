...
/> -->
      <!-- <van-field v-model="info.image" type="image" name="头像" label="头像" alt="未上传头像" clearable >
       ...
       <van-cell is-link @click="showPopup">上传图片</van-cell>
<van-popup v-model="show" round> <van-uploader v-model="fileList" multiple :max-count="1" accept="image/*"  :before-read="before_read"/></van-popup>
