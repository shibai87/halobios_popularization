    ...
    <div id="comment">
        ...
        <div class="comment_other">
            <div v-for="(item,index) in commentList" :key="index">
                <van-row>
                    <van-col span="16" class="comment_content">
                        <div class="comment_other_title">
                            <div v-if="item.user_name">{{item.user_name}}</div>
                            <div v-else>该用户未取用户名</div>
                        </div>

                        <div class="comment_other_content">{{item.comment_content}}</div>
                    </van-col>
                    <van-col span="4" offset="4" class="comment_operation">
                        <van-button size="small" type="primary" @click="addComment">举报</van-button>
                    </van-col>
                </van-row>
            </div>
        </div>
