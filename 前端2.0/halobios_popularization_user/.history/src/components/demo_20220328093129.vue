<template>
  <div>
    ...
    <van-button type="primary" hairline plain round @click="showPopup(-1,-1)">第零级 </van-button>
    <van-button type="primary" hairline plain round @click="showPopup(0,options0_value)">第一级 </van-button>
     <van-button type="primary" hairline plain round @click="showPopup(1,options1_value)">第一级 </van-button>
       <van-button type="primary" hairline plain round @click="showPopup(2,options2_value)">第一级 </van-button>
     <van-button type="primary" hairline plain round @click="showPopup(3,options3_value)">第一级 </van-button>
     <van-button type="primary" hairline plain round @click="showPopup(4,options4_value)">第一级 </van-button>
       <van-button type="primary" hairline plain round @click="showPopup(5,options5_value)">第一级 </van-button>
     <van-button type="primary" hairline plain round @click="showPopup(6,options6_value)">第一级 </van-button>
    <van-popup v-model="show" position="bottom" :style="{ height: '30%' }">
      <van-picker title="请选择第零级分类" show-toolbar :columns="columns" @confirm="onConfirm" @cancel="onCancel"
        @change="onChange"/>
    </van-popup>
    <div >{{options0_value}}---{{options1_value}}---{{this.options2_value}}---{{this.options3_value}}---{{this.options4_value}}---{{this.options5_value}}---{{this.options6_value}}</div>
  </div>
</template>
