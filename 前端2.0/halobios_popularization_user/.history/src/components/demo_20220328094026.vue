<template>
  <div>
    ...
    <van-row gutter="20">
  <van-col span="2">{{options0_value}}</van-col>
  <van-col span="8">span: 8</van-col>
  <van-col span="8">span: 8</van-col>
</van-row>
    <div >---{{options1_value}}---{{this.options2_value}}---{{this.options3_value}}---{{this.options4_value}}---{{this.options5_value}}---{{this.options6_value}}</div>
  </div>
</template>
