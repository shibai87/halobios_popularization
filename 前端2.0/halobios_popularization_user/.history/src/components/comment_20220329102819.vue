        ...
        <div class="comment_content">
            <div v-if="my_judge_comment">
                ...
                <div v-else>
                    ...
                    <van-notice-bar v-else-if="my_report==2" :scrollable="false" text="您的评论已被举报，审核未通过，已设置该评论对其他用户不可见！您可选择删除评论！" />
                    <van-field v-model="my_message" rows="1" center clearable autosize label="我的留言" type="textarea"
            ...
            judgeComment() {
                ...
                this.axios.get(
                    ...
                    .then((res) => {
                        ...
                        console.log(res,res.data,res.data.msg, res.data.data.operation_id, res.data.data.comment_content,
