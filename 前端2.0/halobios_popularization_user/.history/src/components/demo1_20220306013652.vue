<template>
  <div>
     ...
     <ul class="sort">
       <!-- <li>q</li> -->
  <li v-for="(value,index) in sort_type_0[index]" :key="index" class="sort_type">{{sort_type_0[0]}}</li>
  <li v-for="(value,index) in sort_type_0[index]" :key="index" class="sort_type">{{value}}</li>
