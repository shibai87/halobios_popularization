<template>
  ...
  <van-col span="8" class="comment_content">
      <div>{{item.user_name}}</div>
      <div> <van-field v-model="item.comment_content" rows="1" center clearable autosize label="我的留言" type="textarea" placeholder="请输入留言" readonly></div>
  </van-col>
  <van-col span="8" class="comment_operation"><van-button size="small" type="primary" @click="addComment">举报</van-button></van-col>
</van-row>
            </div>
        </div>
