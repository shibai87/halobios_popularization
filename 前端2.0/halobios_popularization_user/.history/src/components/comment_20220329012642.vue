        ...
        <div class="comment_content">
            <van-field v-model="my_message" rows="1" center clearable autosize label="我的留言" type="textarea"
                placeholder="请输入留言"><template #button>
                    <van-button size="small" type="primary" @click="addComment" :v-show="judge_comment==false">提交</van-button>
                    <van-button size="small" type="primary"  :v-show="judge_comment==true">删除</van-button>
                </template></van-field>
        </div>
    </div>
</template>
