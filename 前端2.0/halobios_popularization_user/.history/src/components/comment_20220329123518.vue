                ...
                <div v-if="my_judge_comment">
                    <div v-if="!my_report">
                        <van-field v-model="my_message" rows="1" center clearable autosize label="我的留言" type="textarea"
                            ...
                            <template #button>
                                <van-row gutter="20">
  <van-col span="12"><van-button size="small" type="primary" @click="updateComment">提交修改</van-button></van-col>
  <van-col span="12"><van-button size="small" type="primary" @click="deleteComment">删除</van-button></van-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 修改我的评论内容
            updateComment() {
                this.axios.get("http://192.168.1.103:8083/operation/updateComment?operation_id="+this.operation_id+"&comment_content="+this.my_message)
                    .then((res) => {
