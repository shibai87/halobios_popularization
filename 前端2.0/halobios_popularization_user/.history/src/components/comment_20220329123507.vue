                ...
                <div v-if="my_judge_comment">
                    <div v-if="!my_report">
                        <van-field v-model="my_message" rows="1" center clearable autosize label="我的留言" type="textarea"
                            ...
                            <template #button>
                                <van-row gutter="20">
  <van-col span="8"><van-button size="small" type="primary" @click="updateComment">提交修改</van-button></van-col>
  <van-col span="8"><van-button size="small" type="primary" @click="deleteComment">删除</van-button></van-col>
