<template>
  <div id="sort">
    <van-notice-bar color="#1989fa" background="#ecf9ff" left-icon="info-o" speed=50 text="请通过点击弹出框的确定按钮进行每一级分类的选择！" />
    <van-row gutter="5">
      ...
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(1,options1_value)">第二级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(2,options2_value)">第三级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(3,options3_value)">第四级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(4,options4_value)">第五级 </van-button>
      </van-col>
      <van-col span="6">
    ...
    <van-row gutter="5">
      <div v-if="options0_value">您选择的分类为：</div>
