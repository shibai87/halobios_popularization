...
<script>
    ...
    export default {
        ...
        methods: {
            judgeComment(){
                this.axios.get("http://192.168.1.103:8083/operation/getCommentId?operation_user_id="+this.getUserId+
                                    "&operation_source_type=0"+"&operation_source_id="+this.getKnowledge+"&operation_type=2")
                .then((res)=>{
