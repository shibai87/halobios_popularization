<template>
  <div id="sort">
    ...
    <van-row gutter="5">
      ...
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(-1,-1)">第零级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(0,options0_value)" v-show="options0_value">第一级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(1,options1_value)"  v-show="options1_value">第二级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(2,options2_value)" v-show="options2_value">第三级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(3,options3_value)" v-show="options3_value">第四级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(4,options4_value)" v-show="options4_value">第五级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(5,options5_value)" v-show="options5_value">第六级 </van-button>
      </van-col>
    ...
    <van-divider  :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 16px' }">以下为科普知识列表</van-divider>
  </div>
</template>
