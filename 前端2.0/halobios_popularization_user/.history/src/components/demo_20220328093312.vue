<template>
  <div>
    ...
    <van-button type="primary" hairline plain  @click="showPopup(0,options0_value)">第一级 </van-button>
     <van-button type="primary" hairline plain  @click="showPopup(1,options1_value)">第一级 </van-button>
       <van-button type="primary" hairline plain @click="showPopup(2,options2_value)">第一级 </van-button>
     <van-button type="primary" hairline plain  @click="showPopup(3,options3_value)">第一级 </van-button>
     <van-button type="primary" hairline plain  @click="showPopup(4,options4_value)">第一级 </van-button>
       <van-button type="primary" hairline plain  @click="showPopup(5,options5_value)">第一级 </van-button>
     <van-button type="primary" hairline plain  @click="showPopup(6,options6_value)">第一级 </van-button>
