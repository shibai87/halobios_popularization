            ...
            <div v-for="(item,index) in commentList" :key="index">
                <van-row>
                    ...
                    <van-col span="3" offset="2" class="comment_other_operation">
                        <van-button size="small" type="primary" @click="report(item.operation_id,item.comment_id,item.operation_id,item.comment_id,report_user_id,report_reason)">举报</van-button>
                    </van-col>
                </van-row>
            </div>
        </div>
