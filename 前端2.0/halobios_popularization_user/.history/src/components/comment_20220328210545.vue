    ...
    export default {
        ...
        methods: {
            addComment(){
                ...
                this.axios.get("http://192.168.1.103:8083/operation/getOperationId?operation_user_id="+this.getUserId
                                                                                +"&operation_source_type="+0+"&operation_source_id="+this.getKnowledge+"&operation_type="+2)
                .then((res)=>{
            ...
            a(val){
                    console.log(val,typeof val)
                     this.axios.get("http://192.168.1.103:8083/operation/addComment?operation_id="+val+"&comment_content="+this.my_message)
            }
        },
        mounted() {
