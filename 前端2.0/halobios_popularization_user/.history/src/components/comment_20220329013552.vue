...
<script>
    ...
    export default {
        ...
        methods: {
            judgeComment() {
                this.axios.get(
                        "http://192.168.1.103:8083/operation/getCommentId?operation_user_id=2&operation_source_type=2&operation_source_id=2&operation_type=2"
                        )
                    .then((res) => {
                        console.log(res.data)
                        if (res.data.code == 1) {
                            this.judge_comment = 1
                        } else {
                            this.judge_comment = 0
                        }
