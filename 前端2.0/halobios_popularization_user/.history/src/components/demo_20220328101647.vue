<template>
  <div id="sort">
    ...
    <van-row gutter="5">
      ...
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(2,options2_value)" v-show="options1_value">第三级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(3,options3_value)" v-show="options1_value">第四级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(4,options4_value)" v-show="options1_value">第五级 </van-button>
      </van-col>
      <van-col span="6">
        <van-button type="primary" hairline plain @click="showPopup(5,options5_value)" v-show="options1_value">第六级 </van-button>
      </van-col>
