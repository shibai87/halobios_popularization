<template>
  <div>
<van-dropdown-menu>
  <van-dropdown-item v-model="options0_value" :options="option0"  title="第一级分类" @click="getSort(value0,0)"/>
  <van-dropdown-item v-model="options1_value" :options="option1"   title="第二级分类" />
</van-dropdown-menu>
  </div>
</template>
