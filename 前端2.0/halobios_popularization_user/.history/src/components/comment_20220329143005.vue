        ...
        methods: {
            ...
            judgeComment() {
                if (this.getJudgeLogin) {
                    ...
                    console.log(typeof operation_user_id)
                    this.axios.get(
                            "http://192.168.1.103:8083/operation/judgeOperationId?operation_user_id="+operation_user_id+"&operation_source_type="+0+ "&operation_source_id=" + this.getKnowledgeId)
                        .then((res) => {
