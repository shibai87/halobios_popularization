<template>
  ...
  <van-col span="12" class="comment_content">
      <div>
  ...
  <van-col span="12" class="comment_operation"><van-button size="small" type="primary" @click="addComment">举报</van-button></van-col>
</van-row>
            </div>
        </div>
