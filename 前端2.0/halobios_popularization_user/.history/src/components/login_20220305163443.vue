    ...
    <div id="login_main">
      <van-form @submit="onSubmit">
        ...
        <van-field v-model="password" type="password" name="密码" label="密码" placeholder="请输入密码"  clearable required  
         :focused="showKeyboard_pwd" @focus="showKeyboard_pwd = true" 
...
<style>
/* login_head */
 #login_head .van-nav-bar__content {
    height: 70px;
  }

  #login_head .van-nav-bar__title {
    height: 30px;
    line-height: 30px;
    font-size: 25px;
  ...
  #login_head .van-nav-bar__right {
    right: 5px;
    font-size: 20px;
  }

  #login_head .van-icon:before {
    color: #000;
    font-size: 40px;
