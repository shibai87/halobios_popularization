...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addComment() {
                this.axios.post(
                        "http://192.168.1.103:8083/operation//addSort?operation_user_id="+this.getUserId+"&operation_source_type=2"+"&operation_source_id="+this.getKnowledgeId+"&operation_type=2"+"&comment_content="+this.my_message
                        )
                    .then((res) => {
                        console.log("添加评论")
