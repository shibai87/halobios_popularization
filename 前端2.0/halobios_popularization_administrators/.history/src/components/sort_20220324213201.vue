<template>
    <div id="knowledge_sort">
        ...
        <el-select v-model="options0_value" filterable placeholder="请选择第一级分类" clearable no-match-text="未有相关数据！"
            no-data-text="空空如也！" @change="getSort(options0_value,1)">
...
<script>
    export default {
        ...
        methods: {
            ...
            getSort(value, step) {
                this.$store.commit("getStep",step)
                 this.$store.commit("getSortValue",value)
