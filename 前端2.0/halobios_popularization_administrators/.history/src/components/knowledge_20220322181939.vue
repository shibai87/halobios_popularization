<template>
    <div id="knowledge">
        ...
        <div>
            ...
            <el-table style="width: 100%" height="330px"  border stripe>
                  <el-table-column align="left" label="图片" prop="imageId">
                    <template slot-scope="scope">
                        <img style="width: 100%" :src="Image(scope.$index,scope.row)" />
                    </template>
                </el-table-column>
                <el-table-column align="right" type="index" label="#">sdfg</el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //   },
            Image() {
                var url = "http://localhost:8188/" + "login.jpeg"
                console.log(url)
                return url
            },
