<template>
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
            <el-form-item label="科普知识分类名称 :" prop="knowledge_key">
                <el-input v-model="ruleForm.knowledge_key"></el-input>
            </el-form-item>
            <el-form-item label="科普知识分类关键字" prop="region">
                <el-select v-model="ruleForm.region" placeholder="请第一级分类">
                 ...
                 <el-select v-model="ruleForm.region" placeholder="请第二级分类">
