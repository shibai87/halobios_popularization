    ...
    <div>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
            ...
            <el-form-item label="科普知识分类图片" prop="knowledge_img">
                <el-input type="file" v-model="ruleForm.knowledge_img" accept="image/*"  placeholder="请第二级分类"></el-input>
            </el-form-item>
            <el-form-item>
                    ...
                    if (valid) {
                        this.axios
                            .get("http://localhost:8083/sort/newsort?knowledge_sort_id=" + "1" +
                                "&knowledge_title=" + this.ruleForm.knowledge_title + "&knowledge_content=" +
                                this.ruleForm
