                ...
                this.axios
                    ...
                    .then((res) => {
                        ...
                        console.log(arr.sorts)
                          arr.options0[0]= arr.sorts[0].sort_type_0;
                for (let i = 1; i < arr.sorts.length; i++) {
                    for (let j = 0; j < arr.options0.length; j++) {
                        if (arr.sorts[i].sort_type_0 != arr.options0[j] && j == arr.options0.length -
                            1) {
                           arr.options0[++j] = arr.sorts[i].sort_type_0;
                            break;
                        }
                        if (arr.sorts[i].sort_type_0 == arr.options0[j]) {
                            break;
                        }
                    }
                }
                console.log(arr.options0);
                    });
            },
            sort() {
                console.log("11111")
