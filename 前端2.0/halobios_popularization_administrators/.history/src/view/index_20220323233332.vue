<template>
  ...
  <el-col :span="5" :offset="4"><div class="grid-content bg-purple-light"><Search></Search></div></el-col>
   <el-col :span="1" :offset="8"><div class="grid-content bg-purple-light"> <router-link to="/"> 
