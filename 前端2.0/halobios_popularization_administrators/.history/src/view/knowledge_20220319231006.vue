            ...
            getSortList() {
                this.axios
                    ...
                    .then((res) => {
                        ...
                        this.options0[0].label = res.data[0].sort_type_0;
                        // this.options0[0].label = this.options0[0].value
                    
                        for (let i = 1; i < res.data.length; i++) {
                            for (let j = 0; j <this.options0.length; j++) {
                                
                                if (res.data[i].sort_type_0 != this.options0[j].label && j ==this.options0.length - 1) {
                                     console.log(this.options0[j].label)
                                    this.options0[++j].label = res.data[i].sort_type_0;
                                    // this.options0[j].label = this.options0[j].value;
                                    break;
                                }
                                if (res.data[i].sort_type_0 == this.options0[j].label) {
                                    break;
                                }
                            }
                        }
