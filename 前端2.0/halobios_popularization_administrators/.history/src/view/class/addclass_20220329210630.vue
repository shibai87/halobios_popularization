<template>
    <div id="addClass">
        <el-form :model="ruleForm"  ref="ruleForm" label-width="150px" class="demo-ruleForm">
            ...
            <el-form-item label="活动视频" prop="class_video">
                <el-upload class="upload-demo" ref="upload" action="http://localhost:8083/video/newvideo"
    ...
    export default {
        ...
        methods: {
            submitForm() {
                ...
                if(this.ruleForm.video_title&&this.ruleForm.video_info&&this.class_video_name){
                        this.$refs.upload.submit();
                        this.reload();
                }else{
                     if(!this.class_video_name){
                          this.$message({
                            message: "请上传视频!",
                            type: "warning",
                        });
            ...
            beforeUpload(val) {
                this.class_video_name=val.name
                console.log(val);
            },
            handleChange(file){
