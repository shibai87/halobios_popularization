        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                <el-form-item label="活动主题" prop="class_title" >
                    <el-input v-model="ruleForm.class_title" placeholder="请输入该科普知识的生物学名称">{{}}</el-input>
                </el-form-item>
                ...
                <el-form-item label="(新编辑的)活动视频" prop="class_video">
                    <el-upload class="upload-demo" ref="upload" action="http://localhost:8083/class/updataclass"
        ...
        methods: {
            ...
            // 获取需编辑的知识详情
              getLoadclass() {
                ...
                this.axios.get("http://localhost:8083/class/get_class?class_id="+this.getclass)
                    .then((res) => {
