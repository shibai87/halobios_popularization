  ...
  <div id="index">
    <el-container style="height: 800px; border: 1px solid #eee">
      ...
      <el-container>
        <el-header>
          <el-row>
            <el-col :span="8"><h1 class="index_title">海洋生物科普系统管理平台</h1></el-col>                      
            <el-col :span="6" :offset="1"><Search></Search></el-col>            
            <el-col :span="1" :offset="8">
              <router-link to="/"> <button style="border: none; border-radius: 5px;height: 30px; width: 60px;">注销</button></router-link>  
            </el-col>
          </el-row>
