        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                ...
                <el-form-item label="(新编辑的)活动视频" prop="activity_video">
                    <el-upload class="upload-demo" ref="upload" action="http://192.168.1.103:8083/activity/updataactivity"
    ...
    export default {
        ...
        methods: {
            ...
            // 获取需编辑的知识详情
             ...
             Video() {
        var url = "http://192.168.1.103:8083/activity/" + this.ruleForm.activity_file_name
        console.log(url)
        return url
      },
