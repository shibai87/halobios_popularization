        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                ...
                <el-form-item label="活动介绍" prop="activity_content">
                  ...
                  <el-form-item label="(已上传的)科普知识分类图片" this.ruleForm.activity_video>
                    <div v-show="judge_activity" class="activity_video"><video :src="Image()" /></div>
                </el-form-item>
...
import Sort from "../../components/sort.vue"
    export default {
        ...
        methods: {
            ...
            Image() {
            var url = "http://localhost:8083/activity/" +this.ruleForm.activity_video
            return url
            },
