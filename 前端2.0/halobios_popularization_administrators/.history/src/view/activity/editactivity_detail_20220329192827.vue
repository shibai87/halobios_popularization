    ...
    <div id="editactivity">
        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                <el-form-item label="科普知识名称" prop="activity_title" >
                    <el-input v-model="ruleForm.activity_title" placeholder="请输入该科普知识的生物学名称"></el-input>
                </el-form-item>
                <el-form-item label="(已上传的)科普知识所属分类名" v-if="this.ruleForm.activity_sort_id">
                    <div class="editactivity_sort">
                ...
                <el-form-item label="科普知识分类内容" prop="activity_content">
                    <el-input type="textarea" v-model="ruleForm.activity_content"></el-input>
                </el-form-item>
                  <el-form-item label="(已上传的)科普知识分类图片" this.ruleForm.activity_img>
                    <div v-show="judge_activity" class="activity_img"><img :src="Image()" /></div>
                </el-form-item>
                <el-form-item label="(新编辑的)科普知识分类图片" prop="activity_img">
                    <el-upload class="upload-demo" ref="upload" action="http://localhost:8083/activity/updatasort"
                        ...
                        <el-button v-if="judge_activity" slot="trigger" >重新上传图片</el-button>
...
import Sort from "../../components/sort.vue"
    export default {
        ...
        methods: {
            ...
            Image() {
            var url = "http://localhost:8083/activity/" +this.ruleForm.activity_img
            return url
            },
            ...
            submitForm() {
                ...
                // console.log(this.ruleForm.activity_img,this.activity_img_name)
                if(this.ruleForm.activityactivity_img!=this.activity_img_name&&this.activity_img_name){
            ...
            beforeRemove(file) {
                this.$confirm(`确定移除 ${file.name}？`);
                  this.activity_img_name=null
                console.log(this.activity_img_name);
            },
            ...
            beforeAvatarUpload(file) {
               ...
               handleChange(file){
                this.activity_img_name=file.name
                console.log(this.activity_img_name);
            },
            beforeUpload(val) {
                    this.judge_img=1
        ...
        computed:{
            judge_activity(){
              return  this.$store.state.judgeactivity
            },
            getactivity(){
