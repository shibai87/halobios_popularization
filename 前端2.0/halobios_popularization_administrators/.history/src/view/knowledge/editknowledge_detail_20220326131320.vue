        ...
        <el-main>
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="220px" class="demo-ruleForm">
                ...
                <el-form-item label="科普知识分类内容" prop="knowledge_content">
                  ...
                  <el-form-item label="(已上传的)科普知识分类图片" prop="knowledge_content">
                       <el-image 
    style="width: 100px; height: 100px"
    :src="Image(this.ruleForm)" 
    :preview-src-list="Image(this.ruleForm)">
  </el-image>
                    <!-- <div v-show="judge_knowledge" class="knowledge_img"><img :src="Image(this.ruleForm)" /></div> -->
                </el-form-item>
