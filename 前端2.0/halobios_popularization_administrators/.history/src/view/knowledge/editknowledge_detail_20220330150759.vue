        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                ...
                <el-form-item label="(新编辑的)科普知识分类图片" prop="knowledge_img">
                    <el-upload class="upload-demo" ref="upload" action="http://192.168.1.103:8083/knowledge/updatasort"
...
import Sort from "../../components/sort.vue"
    export default {
        ...
        methods: {
            ...
            // 提交
            submitForm() {
                if(this.getSortListLastId)(this.ruleForm.knowledge_sort_id=this.getSortListLastId)
                // console.log(this.ruleForm.knowledge_img,this.knowledge_img_name)
                if(this.ruleForm.knowledge_img!=this.knowledge_img_name&&this.knowledge_img_name){
