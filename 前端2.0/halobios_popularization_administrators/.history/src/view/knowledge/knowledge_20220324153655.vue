<template>
    <div id="knowledge">
        <div class="sort">
            <el-select v-model="options0_value" placeholder="请第一级分类" @change="get_options0_value(value)">
                <el-option v-for="(item,index) in options0" :key="index" :value="item" :label="item">
                </el-option>
            </el-select>
            <el-select v-model="options1_value" placeholder="请选择第二级分类" @change="get_options1_value(value)">
                <el-option v-for="(item,index) in options0" :key="index" :value="item" :label="item">
                </el-option>
            </el-select>
        </div>
