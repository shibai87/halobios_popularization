<template>
    <div id="knowledge">
        ...
        <Sort></Sort>
        <el-button type="primary" class="knowledge_query" @click="getLoadKnowledgeList()" v-if="knowledgeList.length">开始查询</el-button>
        <el-button type="warning" class="knowledge_query" @click="clear()" v-else>重新选择分类</el-button>
