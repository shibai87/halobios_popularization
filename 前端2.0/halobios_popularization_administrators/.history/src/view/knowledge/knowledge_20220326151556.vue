    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                this.axios.get("http://localhost:8083/knowledge/get_knowledge_list?options_id=")
                    .then((res) => {
            ...
            Knowledge() {
                this.axios.get("http://localhost:8083/knowledge/get_knowledge_list?options_id=" + this
                        .getSortListLastId)
                    .then((res) => {
                        // console.log(res.data)
                        this.knowledgeList = res.data
