    ...
    <div id="editKnowledge">
        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                <el-form-item label="科普知识名称" prop="knowledge_title" class="star">
        ...
        methods: {
            ...
            submitForm() {
                if(this.getSortListLastId)(this.ruleForm.knowledge_sort_id=this.getSortListLastId)
                 ...
                 console.log(this.ruleForm)
                if(this.ruleForm.knowledge_title&&this.ruleForm.knowledge_sort_id!=null&&this.ruleForm.knowledge_content&&this.knowledge_img_name){
...
/* 主体 */
 #editKnowledge  .el-form-item__label .star::before{
content: '*';
    color: #F56C6C;
    margin-right: 4px;
 }
