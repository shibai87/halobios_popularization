<template>
    <div id="knowledge">
        ...
        <Sort></Sort>
        <el-button type="primary" class="knowledge_query" @click="getLoadKnowledgeList()">开始查询</el-button>
        <el-button type="warning" class="knowledge_query" @click="clear()"  v-if="!knowledgeList.length">重新选择分类</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                ...
                this.axios.get("http://localhost:8083/knowledge/get_knowledge_list?options_id=" +null)
                    .then((res) => {
