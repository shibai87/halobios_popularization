                ...
                <el-row>
                    ...
                    <el-col :span="14" :offset=".5">
                        <div class="knowledge_content">
                            <div class="knowledge_title">{{item.knowledge_title}}<el-badge :value="3" class="item">
  <el-button type="warning" icon="el-icon-star-off" circle></el-button></el-badge></div>
    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                ...
                this.axios.get("http://localhost:8083/knowledge/get_knowledge_list?knowledge_upload="+1+"&options_id=")
                    .then((res) => {
            ...
            Knowledge() {
                this.axios.get("http://localhost:8083/knowledge/get_knowledge_list?knowledge_upload="+1+"&options_id=" + this
                        .getSortListLastId)
                    .then((res) => {
                        // console.log(res.data)
                        this.knowledgeList = res.data
