                ...
                <el-row>
                    ...
                    <el-col :span="6" :offset=".5">
                        <div class="knowledge_operation">
                            <el-button type="primary" @click="edit_knowledge(item.knowledge_sort_id)">编辑</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 编辑
            edit_knowledge(knowledge_sort_id){
                this.$store.commit("judgeKnowledge",true)
                 this.$store.commit("getKnowledge",knowledge_sort_id)
