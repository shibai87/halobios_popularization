  ...
  <div id="index">
    <el-container style="height: 800px; border: 1px solid #eee">
      <el-aside width="300px" style="background-color: rgb(238, 241, 246)">
        <el-menu :default-openeds="['1','2', '3','4']">
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-1"  @click="tabSelect(1)">（默认首页）查看知识</el-menu-item>
      ...
      <el-container>
        <el-header>
          <el-row >
  <el-col :span="8"><div class="grid-content bg-purple"> <h1 class="index_title">海洋生物科普系统管理平台</h1> </div></el-col>
  <el-col :span="6" :offset="0.5"><div class="grid-content bg-purple-light"><Search></Search></div></el-col>
   <el-col :span="1" :offset="4"><div class="grid-content bg-purple-light"> <router-link to="/"> 
