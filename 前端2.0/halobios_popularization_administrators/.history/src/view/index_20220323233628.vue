  ...
  <div id="index">
    <el-container style="height: 800px; border: 1px solid #eee">
      ...
      <el-container>
        <el-header>
          <el-row >
  <el-col :span="7"><div class="grid-content bg-purple"> <h1 class="index_title">海洋生物科普系统管理平台</h1> </div></el-col>
  <el-col :span="6" :offset="1"><div class="grid-content bg-purple-light"><Search></Search></div></el-col>
