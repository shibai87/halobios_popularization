      ...
      <el-aside width="300px" style="background-color: rgb(238, 241, 246)">
        <el-menu :default-openeds="['1','2', '3','4']">
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-1" @click="tabSelect(1)">（默认首页）查看知识列表</el-menu-item>
              <el-menu-item index="1-2" @click="tabSelect(2)">新增知识</el-menu-item>
              <el-menu-item index="1-3" @click="tabSelect(3)">未上传的知识列表</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="2">
          ...
          <el-row>
            ...
            <el-col :span="1" :offset="7">
              <router-link to="/"> <button
                  style="border: none; border-radius: 5px;height: 30px; width: 60px;">注销</button></router-link>
            </el-col>
          </el-row>
        </el-header>
