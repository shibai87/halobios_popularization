    ...
    <el-container style="height: 720px; border: 1px solid #eee">
      ...
      <el-container>
        <el-header>
          <el-row>
             <el-col :span="1" >
              <i class="el-icon-refresh-left index_refresh" @click="refresh()" ></i>
            </el-col>
            ...
            <el-col :span="1" :offset="9">
              <router-link to="/">
              <img src="../assets/icon/logout.png" alt="" class="index_icon_logout">
              </router-link>
            </el-col>
          </el-row>
        </el-header>
...
<script>
  ...
  import Report from "../view/user/reportList.vue"
...
#index .el-submenu__title{
  ...
  #index .el-header {
    ...
    /* 刷新图标设置 */
    #index .el-icon-refresh-left{
      font-size: 30px;
      padding: 5px;
    }
    /* 注销图标设置 */
    #index .index_icon_logout{
      width: 30px;
      height: 30px;
      padding: 5px;
    }
