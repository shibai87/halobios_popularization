...
<script>
    ...
    export default {
        ...
        methods: {
            getOperadionNumber() {
                this.$axios.get("http://192.168.197.65:8083/operation/getOperationNumber?operation_source_type=" + this
            ...
            getUserOperation() {
                this.$axios.get("http://192.168.197.65:8083/operation/getUserOperation?user_id=" + this.getUserId +
                ...
                if (this.getJudgeLogin) {
                    if (val == 0) {
                        ...
                        if (this.good_color == "#ff5000") {
                            this.axios.get("http://192.168.197.65:8083/operation/deleteOtherOperation?operation_id=" + this.good_id)
                                .then((res) => {
                        ...
                        // 添加操作
                            ...
                            this.$axios.get("http://192.168.197.65:8083/operation/addUserOperation?user_id=" + this
                                    .getUserId +
                        ...
                        if (this.star_color == "#ff5000") {
                            this.axios.get("http://192.168.197.65:8083/operation/deleteOtherOperation?operation_id=" + this
                                    .star_id)
                                .then((res) => {
                                    if (res.data.msg == '删除操作成功') {
                                        Dialog.alert({
