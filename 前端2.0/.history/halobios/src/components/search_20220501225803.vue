<template>
  <div id="search">
    <van-row>
      ...
      <!-- 搜索按钮 -->
      <van-col span="4" offset="1" class="search_button">
        <van-button type="primary" icon="el-icon-search" @click="getsearch" size="small" class="search_button_begin">搜索</van-button>
      </van-col>
    </van-row>
  </div>
</template>
