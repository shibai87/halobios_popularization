<template>
    <div id="comment">
       <header><h1 class="comment_title">评论</h1></header> 
                        ...
                        <van-field v-model="my_message" rows="1" center clearable autosize label="我的留言" type="textarea"
                            ...
                            <template #button>
                                <van-row gutter="10">
                                    ...
                                    <van-col span="12">
                                        <van-button size="small" type="warning" @click="deleteComment">删除</van-button>
                                    </van-col>
                                </van-row>
                            </template>
                        </van-field>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            judgeComment() {
                this.axios.get("http://192.168.1.105:8083/operation/judgeOperationId?operation_user_id=" + this
                        .getUserId +
            ...
            addComment() {
                this.axios.post(
                        "http://192.168.1.105:8083/operation/addComment?operation_user_id=" + this.getUserId +
                        "&operation_source_type=" + this.getOperationSourceType + "&operation_source_id=" + this
                        .getSourceId +
            ...
            updateComment() {
                ...
                if (this.my_message) {
                    if (this.my_old_message == this.my_message) {
                        ...
                        this.axios.get("http://192.168.1.105:8083/operation/updateComment?operation_id=" + this
                                .operation_id +
                                "&comment_content=" + this.my_message)
                            .then((res) => {
            ...
            deleteComment() {
                Dialog.alert({
                    ...
                    this.axios.get("http://192.168.1.105:8083/operation/deleteComment?operation_id=" + this
                            .operation_id)
                        .then((res) => {
            ...
            getloadComment() {
                if (this.getJudgeLogin) {
                    this.judgeComment()
                    this.axios.get("http://192.168.1.105:8083/operation/getCommentList?operation_source_type=" + this
            ...
            // 举报
            report(comment_id) {
                this.axios.get("http://192.168.1.105:8083/report/add?operation_id=" + this.operation_id +
