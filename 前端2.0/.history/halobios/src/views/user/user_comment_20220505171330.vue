    ...
    export default {
        ...
        methods: {
            ...
            getloadComment() {
                ...
                this.axios.get("http://192.168.197.65:8083/operation/getUserCommentList?operation_user_id=" + this
                        .getUserId)
                    .then((res) => {
            ...
            user_operation_detail(val, operation_source_id) {
                if (val == 0) {
                    // 科普知识
                    this.axios.get("http://192.168.197.65:8083/knowledge/get_knowledge?knowledge_id=" +operation_source_id)
                        .then((res) => {
