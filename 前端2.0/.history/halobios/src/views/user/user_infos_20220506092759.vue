  ...
  export default {
    ...
    methods: {
      ...
      getloadInfo() {
        ...
        // this.axios.get("http://192.168.197.65:8083/user/info?user_id=" + this.getUserId)
      ...
      onSubmit() {
        this.axios.get("http://192.168.197.65:8083/user/updateuser?user_name=" + this.user_name + "&user_pwd=" + this
