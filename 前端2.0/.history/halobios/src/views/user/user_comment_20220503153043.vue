                ...
                <div v-for="(item,index) in commentList" :key="index">
                    <van-row>
                        ...
                        <van-col span="5" offset="2" class="comment_other_operation">
                            ...
                            <van-button size="small" type="warning" @click="deleteComment" v-if="item.comment_state!=0">
                                删除</van-button>
                        </van-col>
                    </van-row>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            user_operation_detail(val, operation_source_id) {
                ...
                if (val == 0) {
                    // 科普知识
                     this.axios.get("http://192.168.1.105:8083/knowledge/get_knowledge?knowledge_id=" + this.getKonwledgeId)
                    .then((res) => {
