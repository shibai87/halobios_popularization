        ...
        methods: {
            ...
            getloadOperation() {
                let operation_type=this.getUserType=="我的点赞"?0:1;
                    this.axios.get(
                            "http://192.168.1.105:8083/operation/getUserOperationList?operation_user_id=" + this.getUserId +"&operation_source_type="+this.active+"&operation_type=" + operation_type)
                        .then((res) => {
