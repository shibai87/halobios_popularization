    ...
    export default {
        ...
        methods: {
            ...
            getloadComment() {
                ...
                this.axios.get("http://192.168.1.105:8083/operation/getUserCommentList?operation_user_id=" + this
                        .getUserId)
                    .then((res) => {
            ...
            user_operation_detail(val, operation_source_id) {
                ...
                if (val == 0) {
                    // 科普知识
                    this.axios.get("http://192.168.1.105:8083/knowledge/get_knowledge?knowledge_id=" +
                            operation_source_id)
                        .then((res) => {
                ...
                if (val == 1) {
                    ...
                    this.axios.get("http://192.168.1.105:8083/activity/get_activity?activity_id=" + operation_source_id)
                        .then((res) => {
                            console.log(res.data)
                            // if (res.data[0].activity_state == 0) {
                ...
                if (val == 2) {
                    ...
                    this.axios.get("http://192.168.1.105:8083/video/get_video?video_id=" + operation_source_id)
                        .then((res) => {
                            console.log(res.data[0])
                            if (res.data[0].video_state == 0) {
                                sessionStorage.setItem('video_id', operation_source_id);
            ...
            deleteComment(operation_id) {
                Dialog.alert({
                    ...
                    this.axios.get("http://192.168.1.105:8083/operation/deleteComment?operation_id=" +
                            operation_id)
                        .then((res) => {
