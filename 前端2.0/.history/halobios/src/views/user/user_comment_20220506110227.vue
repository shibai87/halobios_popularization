...
import OperationService from "../../api/OperationService.js"
    ...
    export default {
        ...
        methods: {
            ...
            getloadComment() {
                OperationService.getloadComment(this.getUserId).then((res) => {this.commentList = res})
            },
            user_operation_detail(val, operation_source_id) {
                ...
                // 科普活动
                if (val == 1) {
                         ActivityService.getLoadactivity(operation_source_id).then((res) => {
                            console.log(res)
                ...
                if (val == 2) {
                    // 科普小课堂
                        VideoService.getLoadclassroom(operation_source_id).then((res) => {
                            console.log(res)
