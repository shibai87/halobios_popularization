<template>
    <div id="commentList">
        ...
        <el-main>
            ...
            <div v-else>
                <el-empty description="没有人评论！" v-if="this.value==0||this.value==1||this.value==2"></el-empty>
...
<script>
    ...
    export default {
        ...
        watch:{
            value(){
                 this.$axios.get("http://192.168.1.105:8083/operation/getAllCommentListByCommentState?operation_source_type=" + this
                        .getOperationSourceType +
