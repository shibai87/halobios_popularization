    ...
    <div id="commentList">
        ...
        <el-main>
            ...
            <div class="commentList_select">
                <el-row :gutter="20">
  <el-col :span="6" :offset="6"><div class="commentList_select_title">评论查询:</div>
                <el-select v-model="value" placeholder="请选择要查询的评论状态">
                    <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                </el-select></el-col>
  <el-col :span="6" :offset="6"> <el-button @click="clear">清空选择</el-button></el-col>
</el-row>
            ...
            <div v-else>
                <el-empty description="该评论状态下无评论！" v-if="this.value==0||this.value==1||this.value==2"></el-empty>
...
<script>
    ...
    export default {
        ...
        watch: {
            value() {
                this.$axios.get(
                        "http://192.168.1.105:8083/operation/getAllCommentListByCommentState?operation_source_type=" +
                        this
                        .getOperationSourceType +
