<template>
  <div id="reportList">
      <el-row  class="reportList_select"  type="flex"  justify="space-around">
        <el-col :span="2">
          <div class="reportList_select_by_comment_state reportList_select_title">评论查询:</div>
        </el-col>
        <el-col :span="4">
        ...
        <el-col :span="4">
          <div class="reportList_select_by_source_type reportList_select_title">评论查询:</div>
        </el-col>
        <el-col :span="4">
  ...
  export default {
    ...
    methods: {
      ...
      seachBySourceTypeAndCommentState() {
        this.$axios.get("http://192.168.1.105:8083/report/getBySourceTypeAndCommentState?operation_source_type=" + this
