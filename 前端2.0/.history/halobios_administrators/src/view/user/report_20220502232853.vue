     ...
     <el-header>
        ...
        <div v-for="(item,index) in report" :key="index" class="infinite-list-item">
          ...
          <el-descriptions class="margin-top comment_Info" :column="1" border>
            <el-descriptions-item   labelStyle="width:200px"  contentStyle="width:1000px">
              <template slot="label">
                <i class="el-icon-tickets"></i>
                评论内容
              </template>
          ...
          <el-descriptions class="margin-top comment_report" :column="3" border>
              <el-descriptions-item labelStyle="width:100px" contentStyle="width:100px">
              <template slot="label">
                <i class="el-icon-tickets"></i>
                审核结果
              </template>
            ...
            <el-descriptions-item labelStyle="width:200px" contentStyle="width:300px">
              <template slot="label">
                <i class="el-icon-tickets"></i>
                审核结果说明
              </template>
