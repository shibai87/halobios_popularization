<template>
  <div id="reportList">
    ...
    <div>
      ...
      <div class="reportList_select_title">评论查询:</div>
      <el-select v-model="source_type" placeholder="请选择要查询的审核状态" clearable>
      ...
      <div v-else>
        <el-empty description="没有人举报！" v-if="this.comment_state==null&&this.source_type==null"></el-empty>
        <el-empty description="无该审核状态下的评论！" v-else-if="this.comment_state!=null"></el-empty>
      </div>
    </div>
