                ...
                <ul class="infinite-list" v-infinite-scroll="load" style="overflow:auto">
                    <li v-for="(item,index) in commentList" :key="index" class="infinite-list-item">
                        <el-descriptions :column="2" border>
                            <el-descriptions-item  labelStyle="width:200px"  contentStyle="width:500px">
                                <template slot="label">
                         ...
                         <el-descriptions border>
                            <el-descriptions-item  labelStyle="width:200px"  contentStyle="width:1500px">
                                <template slot="label">
                                    <i class="el-icon-tickets"></i>
                                    评论内容
                                </template>
                        ...
                        <div  class="commentList_button">
                            <el-button type="primary" size="small" :disabled="item.comment_state=='评论未被举报'" @click="toReport(item.comment_id)">去审核</el-button>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            toReport(comment_id){
                this.$router.push({path:"/report",query:{comment_id:comment_id}})
            }
        },
        computed: {
            getOperationSourceType() {
