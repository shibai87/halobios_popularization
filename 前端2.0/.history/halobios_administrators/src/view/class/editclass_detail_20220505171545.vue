        ...
        <el-main>
            <el-form :model="ruleForm" ref="ruleForm" label-width="220px" class="demo-ruleForm">
                ...
                <el-form-item label="(新编辑的)活动视频" prop="class_video">
                    <el-upload class="upload-demo" ref="upload" action="http://192.168.197.65:8083/video/updatavideo"
    ...
    export default {
        ...
        methods: {
            ...
            getLoadclass() {
                ...
                this.axios.get("http://192.168.197.65:8083/video/get_video?video_id=" + this.getclass)
                    .then((res) => {
            ...
            Video() {
                ...
                var url = "http://192.168.197.65:8083/video/" + this.ruleForm.video_file_name
                console.log(url)
                return url
            },
