...
<script>
  export default {
    ...
    methods: {
      // 获取知识列表+查询列表
      getLoadclassList() {
        this.axios.get("http://192.168.197.65:8083/video/get_video_list?video_upload=" + 0)
          .then((res) => {
      ...
      delete_class(class_id){
        this.axios.get("http://192.168.197.65:8083/video/delete_video?video_id="+class_id)
          .then((res) => {
