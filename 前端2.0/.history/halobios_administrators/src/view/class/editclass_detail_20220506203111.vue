    ...
    export default {
        ...
        methods: {
            ...
            Video() {
                ...
                var url = Constant.URL+"/video/" + this.ruleForm.video_file_name
                return url
            },
            ...
            submitForm() {
                ...
                if (this.ruleForm.video_title && this.ruleForm.video_info && this.video_video_name) {
                    VideoService.get_videoTitle(this.ruleForm.video_title).then((res) => {
                            if (res.msg == '查询成功' && res.data != this.getclass) {
                                this.$message({
