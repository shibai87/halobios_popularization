    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                this.axios.get("http://192.168.197.65:8083/knowledge/get_knowledge_list?knowledge_upload=" + 1 +
                        "&options_id=")
                    .then((res) => {
            ...
            delete_knowledge(knowledge_id, knowledge_img) {
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    this.axios.get("http://192.168.197.65:8083/knowledge/delete_knowledge?knowledge_id=" +
                            knowledge_id +
            ...
            //图片路径
            Image(row) {
                var url = "http://192.168.197.65:8083/knowledge/" + row.knowledge_img
                console.log(url)
                return url
            },
        },
