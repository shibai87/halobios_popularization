        ...
        <el-main>
            <el-form :model="ruleForm"  ref="ruleForm" label-width="220px" class="demo-ruleForm">
                ...
                <el-form-item label="(新编辑的)科普知识分类图片" prop="knowledge_img">
                    <el-upload class="upload-demo" ref="upload" action="http://192.168.197.65:8083/knowledge/updatasort"
...
import Sort from "../../components/sort.vue"
    export default {
        ...
        methods: {
            ...
            // 获取需编辑的知识详情
              getLoadKnowledge() {
                this.axios.get("http://192.168.197.65:8083/knowledge/get_knowledge?knowledge_id=" + this.getKnowledge)
                    .then((res) => {
            ...
            getSort(){
                if(this.ruleForm.knowledge_sort_id!=null){
                       this.axios.get("http://192.168.197.65:8083/knowledge/get_sort?knowledge_sort_id=" +this.ruleForm.knowledge_sort_id)
                    .then((res) => {
            ...
            // 提交
             submitForm() {
                ...
                if (this.ruleForm.knowledge_title && this.ruleForm.knowledge_sort_id != null && this.ruleForm
                    ...
                    this.$axios.get("http://192.168.197.65:8083/knowledge/get_knowledgeTitle?knowledge_title=" + this
