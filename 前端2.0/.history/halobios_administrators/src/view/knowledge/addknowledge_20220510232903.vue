    ...
    export default {
        ...
        methods: {
            ...
            keepForm() {
                ...
                console.log(typeof this.ruleForm.knowledge_title,this.ruleForm.knowledge_title, 
                            typeof this.ruleForm.knowledge_sort_id,this.ruleForm.knowledge_sort_id, 
                            typeof this.ruleForm.knowledge_content,this.ruleForm.knowledge_content, 
                            typeof this.ruleForm.knowledge_upload,this.ruleForm.knowledge_upload)
