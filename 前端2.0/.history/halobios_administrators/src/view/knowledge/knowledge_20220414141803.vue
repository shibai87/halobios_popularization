                ...
                <el-row>
                    ...
                    <el-col :span="6" :offset=".5">
                        <div class="knowledge_operation">
                            ...
                            <el-button type="primary" @click="edit_knowledge(item.knowledge_id)">编辑/查看</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                this.axios.get("http://192.168.1.105:8083/knowledge/get_knowledge_list?knowledge_upload=" + 1 +
                        "&options_id=")
                    .then((res) => {
            ...
            delete_knowledge(knowledge_id, knowledge_img) {
                this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                    ...
                    this.axios.get("http://192.168.1.105:8083/knowledge/delete_knowledge?knowledge_id=" +
                            knowledge_id +
                            "&knowledge_img=" + knowledge_img)
                        .then((res) => {
