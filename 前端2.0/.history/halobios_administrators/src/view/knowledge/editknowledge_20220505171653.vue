    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                this.axios.get("http://192.168.197.65:8083/knowledge/get_knowledge_list?knowledge_upload=" + 0 +
                        "&options_id=")
                    .then((res) => {
            ...
            delete_knowledge(knowledge_id) {
                this.axios.get("http://192.168.197.65:8083/knowledge/delete_knowledge?knowledge_id=" + knowledge_id)
                    .then((res) => {
                        console.log(res.data)
