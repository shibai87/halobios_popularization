                ...
                <el-row>
                    ...
                    <el-col :span="6" :offset=".5">
                        <div class="knowledge_operation">
                            ...
                            <el-button type="primary" @click="delete_knowledge(item.knowledge_id,item.knowledge_img)">删除</el-button>
                        </div>
                    </el-col>
                </el-row>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            getLoadKnowledgeList() {
                KnowledgeService.get_knowledge_list(0).then((res) => {this.editknowledgeList = res})
            },
            // 编辑
