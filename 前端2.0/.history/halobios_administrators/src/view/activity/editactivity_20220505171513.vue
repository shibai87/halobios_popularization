...
<script>
  export default {
    ...
    methods: {
      // 获取知识列表+查询列表
      getLoadactivityList() {
        this.axios.get("http://192.168.197.65:8083/activity/get_activity_list?activity_upload=" + 0)
          .then((res) => {
      ...
      delete_activity(activity_id,activity_file_name){
        this.axios.get("http://192.168.197.65:8083/activity/delete_activity?activity_id="+activity_id+"&activity_file_name="+activity_file_name)
          .then((res) => {
