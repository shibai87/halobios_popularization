            ...
            <el-form :model="ruleForm" ref="ruleForm" label-width="150px" class="demo-ruleForm">
                ...
                <el-form-item label="(新编辑的)活动视频" prop="activity_video">
                    <el-upload class="upload-demo" ref="upload"
                        action="http://192.168.197.65:8083/activity/updataactivity" :on-preview="handlePreview"
    ...
    export default {
        ...
        methods: {
            ...
            getLoadactivity() {
                ...
                this.axios.get("http://192.168.197.65:8083/activity/get_activity?activity_id=" + this.getactivity)
                    .then((res) => {
