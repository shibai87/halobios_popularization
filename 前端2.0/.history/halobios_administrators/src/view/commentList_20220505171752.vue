        ...
        <el-main>
            ...
            <div class="commentList_select">
                <div class="commentList_select_title">评论查询:</div>
                 <el-select v-model="value" placeholder="请选择要查询的评论状态" clearable>
            ...
            <div v-else>
                <el-empty description="没有人评论！" v-if="this.value==null"></el-empty>
                <el-empty description="该评论状态下无评论！" v-else></el-empty>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getLoadCommentList() {
                this.$axios.get("http://192.168.197.65:8083/operation/getAllCommentList?operation_source_type=" + this
        ...
        watch:{
            value(){
                 this.$axios.get("http://192.168.197.65:8083/operation/getAllCommentListByCommentState?operation_source_type=" + this
                        .getOperationSourceType +
                        "&operation_source_id=" + this.getSourceId+"&comment_state="+this.value)
                    .then((res) => {
                        console.log(res.data)
                        this.commentList = res.data
                        for (let i = 0; i < this.commentList.length; i++) {
