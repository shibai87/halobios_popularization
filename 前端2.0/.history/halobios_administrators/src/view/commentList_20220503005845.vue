    ...
    <div id="commentList">
        ...
        <el-main>
            ...
            <div class="commentList_select">
                ...
                <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value" :focus="item.value">
                </el-option>
            </el-select>
            </div>
        ...
        methods: {
            ...
            getLoadCommentList() {
                this.$axios.get("http://192.168.1.105:8083/operation/getAllCommentList?operation_source_type=" + this
                        ...
                        "&operation_source_id=" + this.getSourceId+"&operation_state="+0)
                    .then((res) => {
            ...
            selectCommentList(operation_state){
                console.log(operation_state)
                //  this.$axios.get("http://192.168.1.105:8083/operation/getAllCommentList?operation_source_type=" + this
                //         .getOperationSourceType +
                //         "&operation_source_id=" + this.getSourceId+"&operation_state="+operation_state)
                //     .then((res) => {
                //         console.log(res.data)
                //         this.commentList = res.data
                //         for (let i = 0; i < this.commentList.length; i++) {
