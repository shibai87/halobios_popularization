import request from '../utils/axios'// 使用实例
...
export default {
    ...
    //     return request({
    //         url: `operation/getUserOperation`,
    //         method: 'GET',
    //         params: {
    //             user_id:user_id,
    //             operation_source_type:operation_source_type,
    ...
    //     })
    // },
    // deleteOtherOperation(operation_id) {
    //     return request({
    //         url: `operation/deleteOtherOperation`,
    //         method: 'GET',
    //         params: {
    //             operation_id:operation_id
    //         }
    //     })
    // },
    // addUserOperation(user_id,operation_source_type,operation_source_id,operation_type) {
    //     return request({
    //         url: `operation/addUserOperation`,
    //         method: 'GET',
    //         params: {
    //             user_id:user_id,
    //             operation_source_type:operation_source_type,
    ...
    //     })
    // },
    getAllCommentList(operation_source_type,operation_source_id){
        return request({
            url: `operation/getAllCommentList`,
            method: 'GET',
            params: {
                operation_source_type:operation_source_type,
                operation_source_id:operation_source_id,
    ...
    getAllCommentListByCommentState(operation_source_type,operation_source_id,comment_state){
              return request({
            url: `operation/getAllCommentListByCommentState`,
            method: 'GET',
            params: {
                operation_source_type:operation_source_type,
                operation_source_id:operation_source_id,
